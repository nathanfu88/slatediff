...
var mapDiff = function mapDiff(a, b, p) {
  var ops = [];
  var path = p || '';
...
var sequenceDiff = function sequenceDiff(a, b, p) {
  var ops = [];
  var path = p || '';
  if (Immutable.is(a, b) || a == b == null) {
    return ops;
...
var primitiveTypeDiff = function primitiveTypeDiff(a, b, p) {
  var path = p || '';
  if (a === b) {
    return [];
  } else {
